...
resource "aws_cloudwatch_metric_alarm" "eks_cpu" {
    ...
    statistic = "Average"
    threshold = 80
    alarm_description = "EKS CPU usage above 80%"
...
resource "aws_cloudwatch_dashboard" "eks" {
    dashboard_name = "joel-eks-dashboard-tf"
